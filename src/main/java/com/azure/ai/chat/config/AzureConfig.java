...
public class AzureConfig {
    ...
    public static final String OPENAI_DEPLOYMENT_NAME = System.getenv("AZURE_OPENAI_DEPLOYMENT_NAME");
    
    // Azure Speech 配置
    public static final String SPEECH_KEY = System.getenv("AZURE_SPEECH_KEY");
    public static final String SPEECH_REGION = System.getenv("AZURE_SPEECH_REGION");
    ...
    public static final String BING_CONNECTION_NAME = System.getenv("BING_CONNECTION_NAME");
    
    // 语音配置
    public static final String SPEECH_RECOGNITION_LANGUAGE = "zh-CN";
    public static final String SPEECH_SYNTHESIS_VOICE = "zh-CN-XiaoxiaoNeural";
